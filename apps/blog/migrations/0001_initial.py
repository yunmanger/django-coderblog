...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('blog_category', (
            ...
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=35, db_index=True)),
        ))
        ...
        db.create_table('blog_post', (
            ...
            ('markup', self.gf('django.db.models.fields.CharField')(default='mrk', max_length=3)),
