...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('work_project', (
            ...
            ('desc_ref', self.gf('django.db.models.fields.CharField')(max_length=128)),
        ...
        db.send_create_signal('work', ['Todo'])
    ...
    models = {
        ...
        'work.project': {
            ...
            'desc_ref': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
